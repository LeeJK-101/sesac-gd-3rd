let num: number = 1;
// num = '1'; //  num ='1'//error:number 타입으로 지정한 변수는 문자열로 작성 불가
...
let undef: undefined; // undefined = undefined 에러뜨진 않음
let empty: null = null;

// 원시타입의 경우 작성하지 않아도 ts가 알아서 타입을 추론
// - number, string, boolean, undefined, null 외 타입
let isTrue2 = true;
let undef2;
let empty2 = null;
isTrue2 = 'aa';
...
// 타입스크립트로 팀프로젝트했을 때 any[]는 최대한 자제하는 걸 컨벤션으로 정하기.
