...
export default function FuncEvent() {
  ...
  const handleEnter = (e) => {
    ...
    // code는 해당 이벤트가 발생하기 위해 눌려진 키보드 키를 더 자세히 확인(leftShift인지 rightShift인지)
    // 일반 문자는 keyA와 같이 code뒤에 눌려진 키를 확인할 수 있음
  ...
  return (
    <>
      ...
      <button onClick={msgToKor}>fighting!🔥 </button>
      <button onClick={msgToEng}>힘내세요!💪 </button>
      <br />
      {/* 함수에 매개변수를 전달하는 경우 */}
      {/* 방법 1.  */}
