...
console.log(document.documentElement); // html 문서 내의 모든 elements(요소)들을 rkwudha
...
// HTMLCollection, NodeList -> 유사 배열(배열은 아니지만 배열처럼 보이는)
...
let pinks = document.querySelectorAll('.pink'); // pink 클래스를 가진 모든 요소를 배열로 저장
for (let el of pinks) {
  console.log(el);
}
