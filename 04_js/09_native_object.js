...
let now = new Date();
console.log(now); // Mon Mar 04 2024 11:48:26 GMT+0900 (한국 표준시)
...
console.log(now.getFullYear() + '년'); // + 년 문자열이 됨
...
// 1. Date 객체 사용해 오늘 요일 얻기
console.log(now.getDay());

// TODO: if 조건문으로 작성한 코드를 switch-case 문으로 변경해주세요.
switch (now.getDay()) {
  case 1:
    console.log('월');
    break;
...
function checkweekend() {
  switch (now.getDay()) {
    ...
    case 4:
    case 5:
      return '평일'; // return 작성 시 break 키워드 작성하지 않아도 알아서 해당 스코프 빠져나감 console.log('평일')보다는 일반적으로 return 씀.
    // break;
    case 6:
    case 0:
      return '주말'; // console.log('주말');
    // break;
    default:
      return '알수없음';
    // break;
...
console.log(Math.max(10, 2, 6, -50)); // 최소값: 인자로 전달받은 값 중 최대값
...
console.log(Math.floor(3.4)); // 2 -> 소수를 버림하여 정수로 변환
...
// 20~22 사이의 난수 생성
console.log(Math.floor(Math.random() * 3) + 20);4 -> 
