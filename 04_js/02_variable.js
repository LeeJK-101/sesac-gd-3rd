...
/*
  ...
  - 숫자로 시작 불가(1,2,3.. 안됨 first,secound, one, two 이렇게 쓸 수 있음.)
  - 특수문자는 _, $ 만 허용
  - 공백 문자 사용 불가
  
  사용 가능한 식별자
  a, name, name1, name$, my_name, myName
  (내가 든 예시 yahoo, google, daum, naver, amazon)
  (_나 $로 시작하는 식별자는 거의 없음. 외부에 알려지면 안되는 키워드, 비번, 서버랑 관련되서 금액이 나오는 값(?)등)
    매개변수 같이 안쓴다라는 의미로 사용하기도 함.)
  사용 불가능한 식별자
