...
function useAppend() {
  // append() : 선택된 요소의 마지막 자식으로 인자에 작성된 요소 추가
...
function controlClass() {
  ...
  //   console.log($('#controlClass').hasClass('red')); // 클래스 포함 여부 t/f
  $('#controlClass').toggleClass('red'); // 클래스 토글
  //js 클래스 토글하기
