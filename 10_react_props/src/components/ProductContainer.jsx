  ...
  return (
    <div>
      {/* 
        ...
        - 오류를 방지하기 위해 ? 사용할 수 있음        
          해당 props가 전달 되었다면 체이닝된 메서드를 사용하고 아니라면 실행하지 않음
      ...
      {/* 
        ...
        - 배열의 요소 중 고유한 값(id)이 없다면 가장 **최후의 수단**으로 index를 사용 
        -
      */}
      ...
      {/* 소괄호와 중괄호의 차이. 한줄로 쓰는 화살표 함수(return없는)가 일정 길이이상 길어지면 소괄호가 생긴다. */}
      {products?.map((prod) => (
